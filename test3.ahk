...
input1.Move(10, 120)   ; Vùng nhập 1
input2.Move(110, 120)  ; Vùng nhập 2
input3.Move(210, 120)  ; Vùng nhập 3
input4.Move(310, 120)  ; Vùng nhập 4
input5.Move(10, 180)  ; Vùng nhập 5
input6.Move(110, 180) ; Vùng nhập 6
input7.Move(210, 180) ; Vùng nhập 7
input8.Move(310, 180) ; Vùng nhập 8
input9.Move(10, 240)  ; Vùng nhập 5
input10.Move(110, 240) ; Vùng nhập 6
input11.Move(210, 240) ; Vùng nhập 7
input12.Move(310, 240) ; Vùng nhập 8
